...
use crate::settings::{
    self, CHAT_PANEL_MIN, ComposerSendBehavior, KeymapConfig, RIGHT_PANE_DEFAULT, RIGHT_PANE_MIN,
    SIDEBAR_DEFAULT, SIDEBAR_MAX, SIDEBAR_MIN, SavePolicy, TERMINAL_DEFAULT_HEIGHT, UiSettings,
                    ...
                    .child(
                        div()
                            ...
                            .when(self.space_git_detected(cx), |el| {
                                ...
                                .child(
                                    row("surface-card-history", icons::GIT_BRANCH, "History")
                                        .on_click(cx.listener(|this, _, _, cx| {
