...
const SIDEBAR_SESSION_SLOT: f32 = 63.0 + SIDEBAR_LIST_GAP;
        ...
        let sidebar_lists = crate::edge_fade::edge_faded(
            ...
            div().relative().flex_1().min_h_0().child(
                div()
                    ...
                    // valid pinned slot instead of snapping the row back.
                    .on_drop::<PinnedSessionDrag>(cx.listener(
                ...
                div()
                    ...
                    .child(
                        div()
                            ...
                            .child(
                                row("surface-card-browser", icons::GLOBE, "Browser").on_click(
