...
const SIDEBAR_FOOTER_ACTION_SIZE: f32 = SIDEBAR_ACTIVE_HARNESS_ICON_SIZE + 8.0;
...
impl Shell {
    ...
    /// The sidebar's bottom row: account menu, settings toggle, and the
    /// personal-cut pull-request shortcut. Shared by chat and settings.
