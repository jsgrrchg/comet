...
impl Theme {
    ...
    pub fn install_preferences(appearance: Appearance, accent: AccentColor, cx: &mut App) {
        ...
        Self::install_resolved(Self::for_preferences(appearance, accent), cx);
    ...
    /// Apply device-local typography and keep gpui-base scrollbars in lockstep
    /// with the resolved palette before publishing the theme global.
    fn install_resolved(theme: Self, cx: &mut App) {
        let theme = theme.with_font_sans(crate::typography::effective_family_name(cx));
